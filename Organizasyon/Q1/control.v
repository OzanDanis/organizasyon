module control(
    ...
    always @(*) begin
        case (ALUOp)
            2'b00: // I-type ALU or add for lw/sw
                ALUControl = (opcode==7'b0010011 && funct3==3'b010) ? 3'b101 : // slti
                             (opcode==7'b0010011 && funct3==3'b110) ? 3'b011 : // ori
                             (opcode==7'b0010011 && funct3==3'b111) ? 3'b010 : // andi
                                                                              3'b000; // add/addi
